...
---- FIRST I STARTED BY LOADING THE TWO TABLES INTO THE `PortfolioProject` DATABASE ----

------ NEXT I TOOK A FIRST GLANCE AT BOTH TABLES. GETTING A BETTER SENSE OF WHAT THE TABLES ARE ABOUT, WHAT THEY INCLUDE, ETC. TO PREPARE FOR 
'DATA CLEANSING' -------
...
------ ALREADY I AM NOTICING BOTH TABLES NEED EXTENSIVE CLEANING, THEREFORE I AM REFFERING BACK TO THE BUSINESS OBSTACLE I AM TRYING TO SOLVE
WITH THIS DATA. EVERY DATASET IS DIFFERENT, FURTHERMORE REFERRING BACK TO THE BUSINESS OBSTACLE, WILL ALLOW ME TO UNDERSTAND WHAT I NEED
 TO KEEP AND WHAT DATA CAN BE EXCLUDED. -------
...
-- WILL ASSUME FROM THE DATA THAT THIS BRAND OF SHOE IS CORRECT, OR THE AUTHOR PURPOSELY NAMED THEM SALE. --
...
FROM `womens shoes` 
 ...
 -- I NOTICED LOOKING AT THE DATA THAT SOME OF THE MISSING COLORS AND SIZES ARE LOCATED IN THE SOURCEURLS COLUMN FOR THE MENS SHOES TABLE. I WAS ABLE TO FIND,
 -- SOME OF THE COLORS AND SIZES IN THE SOURCEURLS COLUMN . SO I WILL FIX THAT NOW IN THE MENS SHOES TABLE.--
...
-- I AM CONTINUING TO INPUT THE MISSING DATA IN THE COLUMNS, ALSO WHAT I STARTED DOING WAS RESEARCHING THE DESCRIPTIONS BY COPYING AND PASTING SOME OF THE 
-- SOURCEURLS THAT DO NOT HAVE THE COLORS AND SIZES IN THE DESCRIPTIONS INTO GOOGLE, THAT WAY I CAN FUTHER FIND THE COLORS AND SIZES OF THE ITEMS.--
...
-- I NOTICED THERE WERE OUTLIER FIELDS THAT WERE NOT SHOES BUT OTHER PRODUCTS LIKE JEWELRY, AND ACCESSORIES SO I NEEDED TO REMOVE THEM THATS WHAT I DID BELOW--
...
- Now I AM going to take one last look at both tables to make sure there is nothing else TO BE CLEANED. - 

-- RECAP WHAT STEPS I TOOK IN THIS DATA CLEANSING PROJECT....
...
- NEXT UP IS THE DATA EXPLORATION SEGMENT OF THE LADY AND GENT SHOE PROJECT WHERE I WILL EXPLORE AND ANALYZE THE DATA FOR INSIGHTS TO
 ANSWER THE BUSINESS OBSTACLES. - 
